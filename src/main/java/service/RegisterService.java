...
public class RegisterService {
    ...
    public void clearField(TextField tf_login, TextField tf_password,
                           TextField tf_password_confirm,
                           PasswordField pf_passwordField,
                           PasswordField pf_passwordfield_confirm)
    {
        tf_login.clear();
        tf_password.clear();
        tf_password_confirm.clear();
        pf_passwordField.clear();
        pf_passwordfield_confirm.clear();
